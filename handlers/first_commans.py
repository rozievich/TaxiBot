...
async def help_command(message: types.Message):
    await message.answer("<b>Surxondaryo Taxi</b> Botiga xush kelibsiz 🤖\nBu bot orqali siz ⚙️\nSurxondaryodan Toshkentga yoki Toshkentdan Surxondaryoga taxi topishingiz mumkin 😊\nHammasi oddiy shunchaki /start bosing va tez va oson taxi toping ✅\n\nAdmin: @isakoMR\nSizga shn kabi botlar kerakmi: @rozievich")
